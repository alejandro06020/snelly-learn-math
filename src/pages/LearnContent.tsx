...
const levelContent: Record<string, Page[]> = {
  "1": [
    ...
    { title: "Paso 2: Dividir por 2", content: "Ahora dividimos ambos lados por 2: 2x ÷ 2 = 6 ÷ 2. Esto nos da: x = 3.", narration: `Página cuatro: Paso 2. Dividimos por 2. El resultado es ${equationToVerbal("x = 3")}.` },
